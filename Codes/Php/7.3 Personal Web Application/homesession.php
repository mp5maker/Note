...
if(!isset($_COOKIE['username'])){
    echo "<p><a href = 'loginsession.php'>Log In</a>/<a href = 'signup.php'>Sign Up</a></p>";
}
else{
    echo "<p><a href = 'view.php'>View</a>/<a href = 'edit.php'>Edit</a></p>";
    echo "<p><a href = 'logoutsession.php'>Log Out</a></p>";
}
...
echo " 		   	 <th></th>";
echo " 		   </tr>";
$query = "SELECT first_name, last_name, picture FROM mismatch_user ORDER BY birth_date DESC LIMIT 5";
